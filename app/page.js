...
export default function Home() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="max-w-5xl mx-auto px-5 pt-20 pb-24 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="glass shadow-panel p-6 animate-float">
      ...
      <section className="max-w-5xl mx-auto px-5 py-20 text-center">
        ...
        {session ? (
          <Link
            href="/dashboard"
            className="inline-block bg-ink text-paper px-8 py-3 font-display text-sm uppercase tracking-wider hover:shadow-glow-sm hover:-translate-y-0.5 transition-all duration-300"
          >
